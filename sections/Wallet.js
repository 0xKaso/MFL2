...
export default function SectionWallet() {
  return (
    <SectionWrapper title={t`sectionWallet-title-10`} description={t`sectionWallet-title-11`} id="wallet" sectionColor="#FBBD78">
      <Box marginBottom={{ xs: 4, sm: 6, md: 8 }} sx={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <Box>
          <Step index={1} label={t`sectionWallet-content-10`}>
            <Typography sx={{ wordBreak: 'break-all' }} variant="body1">
              ...
              {` `}
              <Link color="#377dff" target="_blank" href={'https://metamask.io/download/'}>
                https://metamask.io/download/
              </Link>
              ，{t`sectionWallet-content-12`}
            </Typography>
            <LightImage src="/images/installmetamask.jpg" />
            <Typography variant="body1">{t`sectionWallet-content-13`}</Typography>
            <LightImage src="/images/add-to-chrome.jpg" />
          </Step>
          <Step index={2} label={t`sectionWallet-content-14`}>
            <Typography variant="body1">{t`sectionWallet-content-15`}</Typography>
            <LightImage src="/images/create-a-wallet.jpg" />
            <Typography variant="body1">{t`sectionWallet-content-16`}</Typography>
            <LightImage maxWidth={400} src="/images/create-password.jpg" />
            <Typography variant="body1">{t`sectionWallet-content-17`}</Typography>
            <LightImage src="/images/secret-recovery-phrase.jpg" />
            <Typography variant="body1">{t`sectionWallet-content-18`}</Typography>
          </Step>
          <Step index={3} label={t`sectionWallet-content-19`}>
            <Typography variant="body1">{t`sectionWallet-content-20`}</Typography>
            <LightImage src="/images/first-wallet.jpg" />
            <Typography variant="body1">{t`sectionWallet-content-21`}</Typography>
            ...
            <Typography variant="body1">{t`sectionWallet-content-23`}</Typography>
          </Step>
          <Step index={4} label={t`sectionWallet-content-24`}>
            ...
            <Typography variant="body1">{t`sectionWallet-content-26`}</Typography>
        ...
        <Typography variant="h6" textAlign="center" marginBottom={{ xs: 3, sm: 6 }} component="div" sx={{ fontWeight: 900 }}>
            ...
            items={[
              {
                ...
                subtitle: (
                  <Box>
                    ...
                    <Box maxWidth="100%" component="img" src="/images/words-wallets.png" />
                  </Box>
                ),
              },
              {
                ...
                subtitle: (
                  <Box>
                    ...
                    <Link color="#377dff" target="_blank" href={'https://iancoleman.io/bip39/'}>
              ...
              },
              {
                ...
                subtitle: (
                  <Box>
                    ...
                    <LightImage noShadow src="/images/difficulty-of-guessing.jpg" />
                  </Box>
                ),
              },
            ]}
